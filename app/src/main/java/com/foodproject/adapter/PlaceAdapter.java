...
public class PlaceAdapter extends RecyclerView.Adapter<PlaceAdapter.ItemHolder>{
    ...
    public PlaceAdapter(Context context){
        ...
        String[] placeNames = {"Mc'Donald", "Pod Papugami",
                "Starbucks", "Subway", "Kuźnia Smaku", "Kurna chata", "Charlotte", "Setka", "Starbucks", "Dunkin Donuts"};

        String[] placeDelivery = {"Gratis", "7,00zł",
                "Gratis", "5,00zł", "9,00zł", "5,00zł", "Gratis", "7,00zł", "11,00zł", "9,00zł"};

        for (int i = 0; i < 10; i++){
            Place place = new Place((i + 1),placeNames[i], "Sukiennice, " + (i + 1),
